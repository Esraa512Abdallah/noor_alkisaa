...
/*
class CustomPhotoModificationCard extends StatefulWidget {

//   String headText ;
//
//   CustomPhotoModificationCard({
//     required this.headText,
// });

  @override
  State<CustomPhotoModificationCard> createState() => _CustomPhotoModificationCardState();
}

class _CustomPhotoModificationCardState extends State<CustomPhotoModificationCard> {
  @override
  Widget build(BuildContext context) {
    return CustomModificationCard(headText: widget.headText, onPressed: (){
      showDialog(
          context: context,
